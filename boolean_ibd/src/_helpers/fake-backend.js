// For testing method
// Once testing is done, will connect to the real backend
...
export function configureFakeBackend() {
    let users = [
        ...
        { id: 3, email: 'premium', password: 'premium', firstName: 'P', lastName: 'D', role: Role.Premium}
    ];
    ...
    window.fetch = function (url, opts) {
        ...
        return new Promise((resolve, reject) => {
            ...
            setTimeout(() => {
                ...
                // TODO: may need to change user to email
